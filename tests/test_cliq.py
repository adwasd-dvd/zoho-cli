...
def test_build_watch_reply_action_rewrites_package_contract_id_when_mismatched() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
    ...
    assert action["operatorWorkflow"]["packageId"] == "cliq-195"
    assert action["operatorWorkflow"]["packageVersion"] == "v3"
    assert (
        action["operatorWorkflow"]["packageContractId"]
...
def test_build_watch_reply_action_normalizes_uppercase_package_version_prefix() -> None:
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
            "chatId": "CT_1",
            "channelId": "O1",
...
def test_build_watch_reply_action_normalizes_numeric_package_version() -> None:
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
            "chatId": "CT_1",
            "channelId": "O1",
...
def test_build_watch_reply_action_normalizes_float_numeric_package_version() -> None:
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
            "chatId": "CT_1",
            "channelId": "O1",
...
def test_build_watch_reply_action_normalizes_scientific_whole_number_package_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
...
def test_build_watch_reply_action_normalizes_decimal_scientific_whole_number_package_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
    ...
    assert action["operatorWorkflow"]["packageId"] == "cliq-195"
    assert action["operatorWorkflow"]["packageVersion"] == "v35"
    assert (
        action["operatorWorkflow"]["packageContractId"]
        == "cliq-195-operator-workflow-v35"
    )
    assert action["operatorWorkflow"]["packageScope"] == "operator-workflows"


def test_build_watch_reply_action_normalizes_leading_decimal_scientific_whole_number_package_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
    ...
    assert action["operatorWorkflow"]["packageId"] == "cliq-195"
    assert action["operatorWorkflow"]["packageVersion"] == "v5"
    assert (
        action["operatorWorkflow"]["packageContractId"]
        == "cliq-195-operator-workflow-v5"
    )
    assert action["operatorWorkflow"]["packageScope"] == "operator-workflows"


def test_build_watch_reply_action_normalizes_leading_decimal_zero_package_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
...
def test_build_watch_reply_action_preserves_large_scientific_package_version() -> None:
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
            "chatId": "CT_1",
            "channelId": "O1",
    ...
    assert action["operatorWorkflow"]["packageId"] == "cliq-195"
    assert action["operatorWorkflow"]["packageVersion"] == "v1E309"
    assert (
        action["operatorWorkflow"]["packageContractId"]
        == "cliq-195-operator-workflow-v1E309"
    )
    assert action["operatorWorkflow"]["packageScope"] == "operator-workflows"


def test_build_watch_reply_action_normalizes_plus_prefixed_numeric_package_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
...
def test_build_watch_reply_action_normalizes_plus_prefixed_v_package_version() -> None:
    action = cliq.ZohoCliqClient.build_watch_reply_action(
        {
            "chatId": "CT_1",
            "channelId": "O1",
...
def test_build_watch_read_ack_action_rewrites_package_contract_id_when_mismatched() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
...
def test_build_watch_read_ack_action_normalizes_derived_uppercase_contract_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
...
def test_build_watch_read_ack_action_normalizes_derived_numeric_contract_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
            ...
            "channelId": "O1",
            "operatorWorkflow": {
                "packageContractId": "cliq-195-operator-workflow-3",
                "externalEscalation": {
                    "defaultAction": "notify-mail",
                },
            },
...
def test_build_watch_read_ack_action_normalizes_derived_plus_prefixed_contract_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
            ...
            "channelId": "O1",
            "operatorWorkflow": {
                "packageContractId": "cliq-195-operator-workflow-+03",
                "externalEscalation": {
                    "defaultAction": "notify-mail",
                },
            },
...
def test_build_watch_read_ack_action_normalizes_derived_plus_prefixed_v_contract_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
            ...
            "channelId": "O1",
            "operatorWorkflow": {
                "packageContractId": "cliq-195-operator-workflow-+V03",
                "externalEscalation": {
                    "defaultAction": "notify-mail",
                },
            },
...
def test_build_watch_read_ack_action_normalizes_float_numeric_package_version() -> None:
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
            "chatId": "CT_1",
            "channelId": "O1",
...
def test_build_watch_read_ack_action_normalizes_scientific_whole_number_package_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
...
def test_build_watch_read_ack_action_normalizes_decimal_scientific_whole_number_package_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
...
def test_build_watch_read_ack_action_normalizes_leading_decimal_scientific_whole_number_package_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
...
def test_build_watch_read_ack_action_normalizes_derived_leading_decimal_zero_contract_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
            ...
            "channelId": "O1",
            "operatorWorkflow": {
                "packageContractId": "cliq-195-operator-workflow-V.0",
                "externalEscalation": {
                    "defaultAction": "notify-mail",
                },
            },
...
def test_build_watch_read_ack_action_preserves_large_scientific_package_version() -> (
    None
):
    action = cliq.ZohoCliqClient.build_watch_read_ack_action(
        {
...
@respx.mock
def test_execute_watch_reply_action_honors_operator_workflow_external_read_ack_action_hint(
    client: cliq.ZohoCliqClient,
) -> None:
    reply_route = respx.post(
        "https://cliq.zoho.com/api/v2/chats/CT_1/messages/M2/reply"
...
@respx.mock
def test_execute_watch_reply_action_prefers_external_read_ack_action_hint_over_watch_act_action(
    client: cliq.ZohoCliqClient,
) -> None:
    reply_route = respx.post(
        "https://cliq.zoho.com/api/v2/chats/CT_1/messages/M2/reply"
