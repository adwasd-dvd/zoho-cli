...
- Cliq app-governance app-command list verification (`cliq app-commands`) remains externally blocked on happydistrouklimited (`error: not_supported` in latest complete run `tests/auto_pilot/reports/cliq193_app_commands_probe_summary_20260416_053121.json`); missing prior summary was repaired at `tests/auto_pilot/reports/cliq193_app_commands_probe_summary_20260416_025358.json`.
