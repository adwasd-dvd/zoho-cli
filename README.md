...
2. Keep remaining Cliq helper-heavy modularization opportunistic while the
   channel lane moves.
3. Re-run the native OpenClaw Cliq channel RC package preflight and focused channel/docs tests now that the trusted Bot Mention reply smoke is recorded as `trusted_reply_recorded`.
