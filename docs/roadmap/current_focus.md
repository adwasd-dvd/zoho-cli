...
2. **Latest focused live rerun is complete**: `cliq status --check-auth` + `cliq app-commands APP_PROBE_FAKE_20260414_151839` kept auth/export readiness healthy (`oauthReady: true`, `exportOauthReady: true`) while app-command list endpoints remained `not_supported`.
