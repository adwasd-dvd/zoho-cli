...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_snake_title_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_snake_pascal_camel_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_snake_pascal_uppercase_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_snake_pascal_lowercase_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_snake_pascal_snake_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_snake_pascal_snake_title_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_snake_pascal_snake_upper_snake_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_camel_snake_upper_snake_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_kebab_pascal_snake_upper_snake_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_kebab_title_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_kebab_kebab_uppercase_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_kebab_kebab_mixed_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_kebab_pascal_kebab_title_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_kebab_pascal_kebab_lowercase_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_kebab_pascal_kebab_mixed_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_kebab_snake_title_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_pascal_kebab_kebab_mixed_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_pascal_kebab_kebab_uppercase_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_infers_action_from_watch_intake_consume_bridge_action_pascal_kebab_snake_upper_snake_tail_id_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
...
def test_cliq_bridge_run_watch_file_accepts_kebab_case_watch_intake_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
    ...
    assert seen["command"][6] == "--input"
    assert (
        json.loads(seen["command"][7])["watchIntake"] == watch_payload["watch-intake"]
    )
    assert json.loads(seen["command"][7])["actionSourcePath"] == (
        "watch-intake.consume.action_id"
    )

    payload = json.loads(result.output)
    assert payload["actionId"] == "watch-loop"
    assert payload["actionSource"] == "watch-loop-hint"
    assert payload["actionSourcePath"] == "watch-intake.consume.action_id"
    assert payload["actionSourceMetadata"] == {
        "source": "watch-loop-hint",
        "sourcePath": "watch-intake.consume.action_id",
        "fromWatchLoopHint": True,
        "fromEscalationHint": False,
        "fromExplicitOverride": False,
    }
    assert payload["watchIntake"] == watch_payload["watch-intake"]


def test_cliq_bridge_run_watch_file_accepts_kebab_case_consume_policy_action_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
    ...
    assert json.loads(seen["command"][7])["actionSourcePath"] == (
        "watchIntake.consume-policy.action-iD"
    )

    payload = json.loads(result.output)
    assert payload["actionId"] == "watch-loop"
    assert payload["actionSource"] == "watch-loop-hint"
    assert payload["actionSourcePath"] == "watchIntake.consume-policy.action-iD"
    assert payload["actionSourceMetadata"] == {
        "source": "watch-loop-hint",
        "sourcePath": "watchIntake.consume-policy.action-iD",
        "fromWatchLoopHint": True,
        "fromEscalationHint": False,
        "fromExplicitOverride": False,
    }
...
def test_cliq_bridge_run_watch_file_accepts_kebab_case_operator_workflow_alias(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
    ...
    assert (
        ...
        == "operator-workflow.external_escalation.action_hint.bridge_action_id"
    )
    assert payload["operatorWorkflow"] == watch_payload["operator-workflow"]
    assert payload["escalationEnvelopeMetadata"]["fieldSources"]["target"] == {
        "source": "nested-envelope-defaults",
        "sourcePath": (
...
def test_cliq_bridge_run_watch_file_infers_action_from_kebab_case_external_escalation_action_hint(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
    ...
    assert (
        payload["actionSourcePath"]
        == "operator-workflow.external-escalation.action-hint.bridge-action-id"
    )
    assert payload["actionSourceMetadata"] == {
        "source": "escalation-hint",
        "sourcePath": "operator-workflow.external-escalation.action-hint.bridge-action-id",
        "fromWatchLoopHint": False,
        "fromEscalationHint": True,
        "fromExplicitOverride": False,
    }
...
def test_cliq_bridge_run_watch_file_infers_action_from_kebab_case_operator_workflow_internal_loop_hint(
    tmp_path: Path,
    mock_config: Path,
) -> None:
    seen: dict[str, Any] = {}
    ...
    assert (
        payload["actionSourcePath"]
        == "operator-workflow.internal-loop.action-hint.bridge-action-id"
    )
    assert payload["actionSourceMetadata"] == {
        "source": "watch-loop-hint",
        "sourcePath": "operator-workflow.internal-loop.action-hint.bridge-action-id",
        "fromWatchLoopHint": True,
        "fromEscalationHint": False,
        "fromExplicitOverride": False,
    }
