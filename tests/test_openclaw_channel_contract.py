...
def test_openclaw_cliq_channel_rc_checklist_has_cut_contract():
    ...
    required = [
        ...
        "20260512T081613Z-crm-selector-metadata-postcommit-source",
        "20260512T081613Z-crm-selector-metadata-postcommit-decision",
        "ae9424e7d6217bfae6fa75695e03752a1d446eb9",
        "repoChangedFileCount=24",
