...
PAYLOAD="$("$JQ_BIN" -n \
  ...
  | {
      ...
      delugeContract: {
        ...
        webhookResponseReturnRule: "normalize webhook_response into webhook_text and return the clean response map",
      ...
      operatorChecklist: [
        ...
        },
        {
          ...
          normalOperation: "normalize webhook_response into webhook_text; do not keep a fixed received ACK",
