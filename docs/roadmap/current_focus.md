...
2. **`cliq-193` live check for app-permissions is now archived**: focused run (`cliq status --check-auth` + `cliq app-permissions APP_PROBE_FAKE_20260413_034304`) kept auth/export readiness healthy and classified app-permissions endpoints as `not_supported` (`tests/auto_pilot/reports/cliq193_app_permissions_probe_summary_20260413_034304.json`).
