...
## Immediate
1. **`cliq-180` bot-op slices in progress**: `post-to-bot` and `bot-subscribers` are landed with targeted CLI/client tests; next slice is trigger bot calls.
...
## Next
1. `cliq-180`: complete trigger bot call operations
