...
6. Before sending the mention, run the one-shot bundle in plan-only mode to
   ...
   and use `missingFacts` / `readyFacts` as the machine-readable checklist.
