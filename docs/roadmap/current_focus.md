...
2. **`cliq-193` app-command-get live verification is now archived**: focused probe keeps auth/export readiness healthy and classifies app-command detail endpoints as `not_supported` on happydistrouklimited.
