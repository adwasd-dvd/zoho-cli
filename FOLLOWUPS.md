...
- [x] Re-run nightly broad verification gate while cliq-180 first slice is active; latest run is green at 321 tests + wheel smoke + fmt/lint (`2026-04-12T14:19:04Z`).
