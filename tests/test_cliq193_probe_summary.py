...
def test_build_summary_normalizes_prefixed_top_level_error_hint(tmp_path):
    status_file = tmp_path / "status.json"
    app_commands_file = tmp_path / "app_commands.json"
    status_file.write_text(json.dumps({"oauthReady": True, "exportOauthReady": True}))
    app_commands_file.write_text(
    ...
    summary = build_summary(
        stamp="20260504_131001",
        probe_app_id="APP_PROBE_FAKE_20260504_131001",
        status_command="status",
        app_commands_command="app-commands",
        status_exit_code=0,
        app_commands_exit_code=1,
        status_file=status_file,
        app_commands_file=app_commands_file,
        timestamp_utc="2026-05-04T13:10:01Z",
    )
...
def test_build_summary_normalizes_spaced_top_level_error_hint(tmp_path):
    status_file = tmp_path / "status.json"
    app_commands_file = tmp_path / "app_commands.json"
    status_file.write_text(json.dumps({"oauthReady": True, "exportOauthReady": True}))
    app_commands_file.write_text(
    ...
    summary = build_summary(
        stamp="20260504_131002",
        probe_app_id="APP_PROBE_FAKE_20260504_131002",
        status_command="status",
        app_commands_command="app-commands",
        status_exit_code=0,
        app_commands_exit_code=1,
        status_file=status_file,
        app_commands_file=app_commands_file,
        timestamp_utc="2026-05-04T13:10:02Z",
    )
...
def test_build_summary_prefers_strongest_unsupported_hint_from_error_object(tmp_path):
    status_file = tmp_path / "status.json"
    app_commands_file = tmp_path / "app_commands.json"
    status_file.write_text(json.dumps({"oauthReady": True, "exportOauthReady": True}))
    app_commands_file.write_text(
    ...
    summary = build_summary(
        stamp="20260504_141001",
        probe_app_id="APP_PROBE_FAKE_20260504_141001",
        status_command="status",
        app_commands_command="app-commands",
        status_exit_code=0,
        app_commands_exit_code=1,
        status_file=status_file,
        app_commands_file=app_commands_file,
        timestamp_utc="2026-05-04T14:10:01Z",
    )
...
def test_build_summary_prefers_stderr_unsupported_hint_when_json_is_invalid(tmp_path):
    status_file = tmp_path / "status.json"
    app_commands_file = tmp_path / "app_commands.json"
    app_commands_stderr = tmp_path / "app_commands.stderr"
    status_file.write_text(json.dumps({"oauthReady": True, "exportOauthReady": True}))
    ...
    summary = build_summary(
        stamp="20260504_120003",
        probe_app_id="APP_PROBE_FAKE_20260504_120003",
        status_command="status",
        app_commands_command="app-commands",
        status_exit_code=0,
        app_commands_exit_code=1,
        status_file=status_file,
        app_commands_file=app_commands_file,
        timestamp_utc="2026-05-04T12:00:03Z",
    )
...
def test_build_summary_normalizes_spaced_unsupported_stderr_hint(tmp_path):
    status_file = tmp_path / "status.json"
    app_commands_file = tmp_path / "app_commands.json"
    app_commands_stderr = tmp_path / "app_commands.stderr"
    status_file.write_text(json.dumps({"oauthReady": True, "exportOauthReady": True}))
    app_commands_file.write_text("")
    app_commands_stderr.write_text("endpoint is not supported for this app")

    summary = build_summary(
        stamp="20260504_120002",
        probe_app_id="APP_PROBE_FAKE_20260504_120002",
        status_command="status",
        app_commands_command="app-commands",
        status_exit_code=0,
        app_commands_exit_code=1,
        status_file=status_file,
        app_commands_file=app_commands_file,
        timestamp_utc="2026-05-04T12:00:02Z",
    )
