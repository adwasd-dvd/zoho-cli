...
def test_openclaw_cliq_channel_rc_checklist_has_cut_contract():
    ...
    required = [
        ...
        "20260512T091513Z-crm-command-previews-postcommit-source",
        "20260512T091513Z-crm-command-previews-postcommit-decision",
        "df683f7e0bba4650cdff23bc7692cbfcc2545e51",
        "repoChangedFileCount=25",
