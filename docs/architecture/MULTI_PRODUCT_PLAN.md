...
- Keep CRM SDK work behind an adapter/parity gate; `crm-005` exposes only explicit `--adapter sdk-v8` read gates, and default CRM command output must not change until v8 alignment evidence is recorded.
