...
2. `cliq-193`: take the next smallest app-governance command/client/output-hardening slice with focused tests.
3. `cliq-193`: run one focused live verification pass for that next slice and archive evidence.
