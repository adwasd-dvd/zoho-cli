...
- CRM write planning:
  ...
  - treat `liveWritesEnabled=false` as authoritative until the audit
    persistence and controlled fixture blockers are cleared in a later slice
