...
2. **Latest `cliq-193` focused live rerun is complete**: reran `cliq status --check-auth` + `cliq app-permissions APP_PROBE_FAKE_20260414_064355` and archived evidence at `tests/auto_pilot/reports/cliq193_app_permissions_probe_summary_20260414_064355.json`; auth/export readiness stays healthy (`oauthReady: true`, `exportOauthReady: true`) while app-permissions remains `not_supported`.
