...
2. **`cliq-193` app-commands live verification is now archived**: focused probe (`cliq status --check-auth` + `cliq app-commands APP_PROBE_FAKE_20260413_050402`) kept auth/export readiness healthy and classified app-command endpoints as `not_supported`.
