...
- For CRM SDK work, run `zoho crm sdk-status` first. Treat
  ...
  `stop_before_operator_live_fixture`. Execute only when it reports
  `agent_next_command_ready`; otherwise collect the missing operator input or
  stop for live fixture approval.
